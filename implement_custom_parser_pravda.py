...
class UpdateDB:
    ...
    def __init__(self, col_to_scrape = None,
        ...
        self.dates = pd.date_range(start=datetime(start_year,10,1), end=datetime(2021,11,1), freq='m')
...
#################
    ...
    def pravda_story(self, soup,url):

        """
        Function to pull the information we want from pravda stories
        ...
        # Get Title: 
        try:
            article_title = soup.find_all('meta',property='og:title')[0]['content']
    ...
    def update_db(self, l, yr, mo):
        ...
        for url,id in tqdm(lines):
            ...
            try:
                d['maintext'] =  self.pravda_story(soup, url=url)['maintext']
            except:
                d['maintext'] = None
            ...
            try:
                d['title'] = self.pravda_story(soup, url=url)['title'] #change
            except:
                d['title'] = None
            ...
            try:
                d['date_publish'] = self.pravda_story(soup,url=url)['date_publish'] #change
            except:
                d['date_publish'] = None
