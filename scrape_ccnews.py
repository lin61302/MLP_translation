...
my_local_download_dir_warc = '/home/ml4p/cc_download_warc'
# download dir for articles
my_local_download_dir_article = '/home/ml4p/cc_download_articles'
# hosts (if None or empty list, any host is OK)
my_filter_valid_hosts = []  # example: ['elrancaguino.cl']
# start date (if None, any date is OK as start date), as datetime
my_filter_start_date = datetime.datetime(2012, 1, 1)  # datetime.datetime(2016, 1, 1)
...
if __name__ == "__main__":
    ...
    db = MongoClient(uri, maxPoolSize=1000).ml4p
    main(uri=uri, num_cpus=10)
